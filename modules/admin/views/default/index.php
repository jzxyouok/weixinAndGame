...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a _href="<?=\yii\helpers\Url::toRoute(['rbac/index']) ?>" href="javascript:void(0)">角色管理</a></li>
                    <li><a _href="<?=\yii\helpers\Url::toRoute(['rbac/permission'])?>" href="javascript:void(0)">权限管理</a></li>
                    <li><a _href="<?=\yii\helpers\Url::toRoute(['rbac/admin-list'])?>" href="javascript:void(0)">管理员列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?=\yii\helpers\Url::to(['default/welcome'])?>"></iframe>
        </div>
    </div>
</section>
